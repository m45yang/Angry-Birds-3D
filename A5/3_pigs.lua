...
pig_right_nostril = gr.mesh('sphere', 'pig_right_nostril')
...
pig1:scale(3.0, 3.0, 3.0)
pig1:translate(-5.0, -0.5, 0.0)
pig1:add_child(pig)

bird1 = gr.node('bird1')
rootnode:add_child(bird1)
bird1:scale(3.0, 3.0, 3.0)
-- bird1:rotate('x', -90)
bird1:translate(5.0, -0.5, 0.0)
